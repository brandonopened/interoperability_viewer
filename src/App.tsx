    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${appView === 'viewer'
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${appView === 'compare'
                    ? 'bg-blue-600 text-white'
                    : 'bg-slate-100 text-slate-700 hover:bg-slate-200'
                  }`}
              >
                ...
                <div className="space-y-2">
                  {specifications.map((spec) => (
                    <button
                      ...
                      className={`w-full text-left px-4 py-3 rounded-lg transition-all ${selectedSpec.id === spec.id
                    ...
                    >
                      ...
                      <span
                        className={`text-xs px-2 py-0.5 rounded border ${organizationColors[spec.organization]
                          }`}
                      >
                        {spec.organization}
                      </span>
                ...
                <div className="p-6 border-b border-slate-200">
                  ...
                  <div className="flex flex-wrap gap-3 mt-4">
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${viewMode === 'overview'
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${viewMode === 'schema'
                          ? 'bg-blue-100 text-blue-700 border-2 border-blue-500'
                          : 'bg-slate-100 text-slate-700 hover:bg-slate-200 border-2 border-transparent'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${viewMode === 'example'
                          ? 'bg-blue-100 text-blue-700 border-2 border-blue-500'
                          : 'bg-slate-100 text-slate-700 hover:bg-slate-200 border-2 border-transparent'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${viewMode === 'diagram'
                          ? 'bg-blue-100 text-blue-700 border-2 border-blue-500'
                          : 'bg-slate-100 text-slate-700 hover:bg-slate-200 border-2 border-transparent'
                        }`}
                    >
      ...
      <footer className="bg-white border-t border-slate-200 mt-12">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col items-center gap-2">
          ...
          <a
            href="https://github.com/brandonopened/interoperability_viewer/tree/main"
            target="_blank"
            rel="noopener noreferrer"
